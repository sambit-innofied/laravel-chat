                        ...
                        <div class="row text-right mt-2">
                            ...
                            <div class="col-lg-2">
                                <button type="button" v-on:click="sendMessage()"
                                    class="btn btn-small btn-success w-100">Send Event</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        new Vue({
            ...
            methods: {
                ...
                subscribeToAllChannels() {
                    [
                        "api-message"
                    ].forEach(channelName => this.subscribeToAllChannel(channelName));

                },
                subscribeToAllChannel(channelName) {
                    let inst = this;
                    this.pusher.subscribe(
                        this.logChannel + channelName
